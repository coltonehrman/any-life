<>
  <div class="nav-item" onclick="showPopup('#popup-confirm-${p.id}')">
    <div class="nav-text">
    ...
    <div class="popup-box">
      ...
      <div class="popup-details">
        <div class="popup-detail">
          <span class="popup-detail-label">Price:</span>${p.price.format()}
        </div>

        <div class="popup-detail">
          <span class="popup-detail-label">Address:</span>${p.address}
        </div>
      ...
      <div class="progress-section">
        ...
        <div class="progress-track">
          <div class="progress-fill" style="width: ${p.condition}%;"></div>
        </div>
      </div>
